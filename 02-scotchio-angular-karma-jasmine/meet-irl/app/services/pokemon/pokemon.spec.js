describe('Pokemon factory', function() {
    ...
    describe('.findByName()', function() {
        ...
        it('should return a Pokemon when called with a valid name', function() {
            ...
            $httpBackend.whenGET(API_ENDPOINT + search).respond(200, $q.when(RESPONSE_SUCCESS));
        ...
        it('should return 404 when called with an invalid name', function() {
            var search = 'godzilla';

            $httpBackend.whenGET(API_ENDPOINT + search).respond(404, $q.reject(RESPONSE_ERROR));
